...
var equivelent = ['0123456789','０一二三四五六七八九'];
/*
...
function wsub(a,b){
	...
	if(idx>=0){
		...
		//deal with numbers
		var ad = equivelent[0].indexOf(a);
		ad = ad<0 ? equivelent[1].indexOf(a):ad;
		var bd = equivelent[0].indexOf(b);
		bd = bd<0 ? equivelent[1].indexOf(b):bd;
		if(ad>=0 && bd>=0){
			return ad==bd?0.2:1;	
		} 
		return 1;
